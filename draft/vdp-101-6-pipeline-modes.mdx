...
**Pipeline** is the most important concept in VDP. Check the [documentation](/docs/latest/core/concepts/pipeline/?utm_source=blog&utm_medium=link&utm_campaign=vdp-101-6-pipeline-modes) for more details.
