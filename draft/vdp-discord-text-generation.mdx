...
<InfoBlock type="info" title="info">
VDP is implemented with [API-first](/docs/latest/core/concepts?utm_source=tutorial&utm_medium=link&utm_campaign=vdp-discord-text-generation) design principle. It enables seamless integration to your data stack at any scale.
