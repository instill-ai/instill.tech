...
<InfoBlock type="info" title="info">
VDP is implemented with [API-first](/docs/latest/core/introduction?utm_source=tutorial&utm_medium=link&utm_campaign=vdp-discord-text-generation) design principle. It enables seamless integration to your data stack at any scale.
...
<CtaButton
  ...
  link="https://www.instill.tech/?utm_source=tutorial&utm_medium=link&utm_campaign=vdp-discord-text-generation?utm_source=blog&utm_medium=link&utm_campaign=vdp-discord-text-generation"
/>
