  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <div className="mx-auto mb-0 flex items-end space-y-4 xl:flex-row xl:gap-x-14 xl:space-y-0">
          <PricingInfoCard
            price="Free"
            tier="free"
            className="h-[424px] w-[240px]"
            features={[
          ...
          >
            <PricingInfoCard
              price="199"
              tier="team"
              className="h-[624px] w-[240px] bg-[#FFFFFF99]"
              features={[
                "Up to 50 project members",
                "Unlimited tasks and projects",
                "50GB storage",
