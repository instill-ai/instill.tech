import { LicensePageLayout } from "@/components/legal";
export const meta = {
  title: "Instill Community License Version 1.0 | Instill AI",
  description: "Instill Community License Version 1.0",
};

export default ({ children }) => (
  <LicensePageLayout meta={meta}>{children}</LicensePageLayout>
);
