...
To set it up, click the **Source type** ▾ drop-down and choose `HTTP`.
...
2. Click the **Model type** ▾ drop-down and choose `GitHub`
...
Once the model is imported, click the **Model instances** ▾ drop-down, pick one model instance, and click **Deploy** to put it online.
...
Now you should see the newly created pipeline on the **Pipeline** page 🎉

![Pipeline list page of the VDP Console](/docs-assets/tutorials/pipeline-list.png)
