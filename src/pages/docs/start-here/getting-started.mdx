...
You should see the onboarding page if this is your first time using the [Console](http://localhost:3000). Please enter your email to proceed.

![Onboarding page of the VDP Console](/docs-assets/start-here/onboarding.png)

Jump right in

⚡️ [Build a SYNC pipeline with no-/low-code](/docs/tutorials/build-a-sync-pipeline)
