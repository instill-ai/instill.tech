...
**Console** is the _no-code_ VDP platform. The goal is to provide an unified, clean and intuitive user experience of VDP.
It is written using [Nextjs](https://nextjs.org), [Typescript](https://www.typescriptlang.org) and [TailwindCSS](https://tailwindcss.com).
