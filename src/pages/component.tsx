...
const ComponentPage: NextPageWithLayout = () => {
  ...
  return (
    <React.Fragment>
        ...
        <div className="mt flex flex-col">
          ...
          <div className="flex justify-center">
            <div className="w-[480px]">
              <div className="mb-5 grid grid-cols-1 gap-x-5 gap-y-2">
              ...
              <div className="mb-5 grid grid-cols-2 gap-x-5 gap-y-2">
                <div className="flex w-full flex-col gap-y-2.5">
                  <p className="text-semantic-fg-primary product-body-text-3-semibold">
                    Category
                  </p>
                ...
                <div className="flex w-full flex-col gap-y-2.5">
                  ...
                  >
                    ...
                    <Select.Content>
                      <Select.Group>
                        <Select.Item value="All">All</Select.Item>
                        <Select.Item value="RELEASE_STAGE_ALPHA">
                          Alpha
                        </Select.Item>
                        <Select.Item value="RELEASE_STAGE_BETA">
                          Beta
                        </Select.Item>
      ...
      <div
        style={{
          backgroundImage: 'url("/images/component/bg-component.svg")',
          backgroundSize: 2000,
        }}
        className="rounded-b-sm bg-cover bg-no-repeat"
      >
        <ContentContainer margin="mb-[20px]" contentMaxWidth="max-w-[1127px]">
          ...
          {connectors && connectors.length !== 0 && (
            <div className="flex flex-row justify-between">
              <Button
                ...
                className="gap-x-2"
                onClick={() =>
                  router.push(`/component?page=${currentPage - 1}`)
                }
