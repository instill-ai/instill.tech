                  ...
                  <div className={cn("flex w-2/5 flex-col")}>
                    ...
                    <div className="mb-10 space-y-4">
                      <p className="font-sans font-normal">
                        Boost Your AI Development with Our Versatile Data
                        Pipeline!{" "}
                      </p>
                      <p>
                        Our Versatile Data Pipeline powers your AI apps with
                        virtually endless data, regardless of use case.
                        Seamlessly integrate your unstructured data and harness
                        the versatility of AI with Instill AIs rapidly expanding
                        community of data connectors.
                      </p>
                      ...
                      <p>
                        Experience the future with our interactive demo ⚡️.
                      </p>
                    </div>
                    <div className="flex flex-col">
