  ...
  return (
    <div className="row mb-12 flex w-full flex-col">
      ...
      <div
        ...
        style={{
          backgroundImage: 'url("/images/about/glow-2.png")',
      ...
      >
        <div className="rounded-sm p-[30px] shadow-lg">
          <p className="font-mono text-[16px] font-normal leading-6 text-[#1D2433]">
            ...
            usually focus on structured data, neglecting the fact that 80% of
            the world&apos;s data is unstructured and challenging to analyze.
            This gap in capability is precisely where Instill AI comes in, as
            many companies lack the knowledge or resources to effectively manage
            ...
            , an open-source, modularized ETL infrastructure specifically
            designed to address the challenges of unstructured data. This launch
            reinforced the company&apos;s dedication to democratizing AI access
            and exemplified their ongoing commitment to overcoming obstacles in
