  ...
  return (
    <div className="my-10 w-full text-center xl:text-left">
      ...
      <p className="font-sans text-base font-normal leading-7 text-zinc-900">
        Instill AI was founded with the vision of easing the difficulties of AI
        product development, driven by a shared understanding of the
        complexities involved in AI development. The company recognizes that
        unstructured data ETL is crucial but often overlooked in the modern data
        stack. Despite many companies claiming to be data-driven, they usually
        focus on structured data, neglecting the fact that 80% of the
