    ...
    <div className="my-12 w-full text-left">
      ...
      <div className="grid grid-cols-1 gap-5 xl:grid-cols-2">
        <div
          ...
          style={{
            backgroundImage: 'url("/images/about/glow-3.png")',
            backgroundPosition: "right",
          }}
        >
          <div className="flex flex-col rounded-sm bg-opacity-80 p-[30px] shadow-lg backdrop-blur-sm">
            ...
            <p className="font-mono text-[14px] font-normal leading-5 text-[#000000B2]">
              At the core of our company, we&apos;re driven by the success of
              our users. We thrive when we deeply understand their needs and go
              the extra mile to provide them with exceptional value, making
        ...
        >
          <div className="rounded-sm bg-opacity-80 p-[30px] shadow-lg backdrop-blur-sm">
            <div className="flex flex-row">
              <div className="mb-5 rounded-sm border p-2.5 shadow-sm">
                <svg
                  width="21"
        ...
        >
          <div className="rounded-sm bg-opacity-80 p-[30px] shadow-lg backdrop-blur-sm">
            ...
            <Separator className="my-2" />
            <p className="font-mono text-[14px] font-normal leading-5 text-[#000000B2]">
              Taking ownership of our responsibilities and proactively
              addressing challenges is a fundamental part of our work ethic. We
              hold ourselves accountable for our actions and outcomes, driving
