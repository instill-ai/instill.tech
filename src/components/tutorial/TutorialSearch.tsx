  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-row">
        <a
          href="https://github.com/instill-ai/instill-core/issues/new?labels=tutorial%2Cdocumentation%2Cneed-triage&template=tutorial_request.yaml&title=%5BTutorial%5D+%3Ctitle%3E"
        ...
        <a
          href="https://github.com/instill-ai/instill-core/issues/new?assignees=xiaofei-du,EiffelFly&labels=submit+a+tutorial"
          className="px-2.5 py-[5px] font-sans text-lg font-normal text-instillGrey70 hover:text-instillSkyBlue"
        >
          Submit a tutorial
        </a>
