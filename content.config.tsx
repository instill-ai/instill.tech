...
const getSections = (appVersion: InstillAppVersion): SidebarSections[] => {
  return [
    ...
    },
    {
      ...
      items: [],
      appType: "vdp",
      versions: ["1.39.0", "v1.37.0", "v1.0.0"],
    },
    {
  ...
  return {
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          {
            key: "docs-nav-dropdown-version-VDP",
            position: "right",
            border: true,
            label: "VDP",
            appType: null,
