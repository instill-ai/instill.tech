...
themeImgSrc: "/blog-assets/introducing-vdp/instill-vdp-concept-figure.png"
themeImgAlt: "Introducing VDP: a general and modularised ETL infrastructure for unstructured data"
themeImgThumbnailSrc: "/blog-assets/introducing-vdp/instill-vdp-concept-figure.png"
...
Check out [highlights](/docs/latest/welcome?utm_source=blog&utm_medium=link&utm_campaign=introducing-vdp) and [core concepts](/docs/latest/core/introduction?utm_source=blog&utm_medium=link&utm_campaign=introducing-vdp) if you want to learn more about how VDP works.

~~To benefit a broader community, we release VDP under the open-source Apache license 2.0. Check it out [here](https://github.com/instill-ai/instill-core/blob/main/LICENSE).~~
...
VDP is in Alpha and under active and heavy development. Check out our open [roadmap](/docs/latest/roadmap?utm_source=blog&utm_medium=link&utm_campaign=introducing-vdp). If you have any questions or feature requests, [create an issue](https://github.com/instill-ai/instill-core/issues) or hop into our [Discord](http://go.instill.tech/4ey9lz) to get help from an active and friendly community!
...
<CtaButton
  ...
  link="https://www.instill.tech/?utm_source=blog&utm_medium=link&utm_campaign=introducing-vdp"
/>
