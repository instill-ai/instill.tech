...
lang: "en-US"
draft: false
description: "We are announcing a $3.6M seed round led by RTP Global to boost the open-source ML tool for unstructured data and make AI accessible for everyone."
...
Also, thank you to the Instill AI team. Your expertise and enthusiasm for open-source software has helped build the virtuous flying wheel to develop high-quality software products. And last, but not least, thank you to the investors and advisors who share our vision for their financial support and insightful opinions.
...
In early 2022, we shifted our approach to a more comprehensive platform. We started working on the unstructured data infrastructure to fulfil our mission of making AI more accessible to everyone. Enter VDP.
...
We are going to devote all our efforts to building the open-source infrastructure for unstructured data.

To achieve this goal, we will double the size of our team by the end of 2023 (please check our [open roles](https://www.instill.tech/career)).
