...
We are going to devote all our efforts to building the open-source infrastructure for unstructured data. To achieve this goal, we will double the size of our team by the end of 2023 (please check our [open roles](/career/?utm_source=blog&utm_medium=link&utm_campaign=seed-round-announcement)).
