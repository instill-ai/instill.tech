...
1. add a HTTP source,
2. import and deploy a model from the `v1.0-cpu` tag of the GitHub repository [instill-ai/model-yolov7](https://github.com/instill-ai/model-yolov7-dvc) with ID **yolov7**,
...
+--------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------+
| 749e2ae7-dfc4-4f8d-bc32-01a515aca155 | {"index": "01GD9K7SR21Y507S3XSC350E53", "pipeline": {"name": "pipelines/detection", "recipe": {"source": "source-connectors/source-http", "destination": "destination-connectors/postgres-db", "model":[.| 2022-09-19 00:44:14.414+00 |
|                                      |."models/yolov7"]}}, "detection": {"objects": [{"score": 0.94767153, "category": "cow", "bounding_box": {"top": 327, "left": 481, "width": 514, "height": 389}}, {"score": .|                            |
...
|                                      |.h": 401, "height": 252}}]}, "model": "models/yolov7"}                                                                                                                        |                            |
...
|                                      |.stances": ["models/yolov7"]}}, "detection": {"objects": [{"score": 0.94896084, "category": "cow", "bounding_box": {"top": 321, "left": 483, "width": 507, "height": 395}}, {"score": .|                            |
...
|                                      |.3, "left": 870, "width": 295, "height": 114}}]}, "model": "models/yolov7"}                                                                                                   |                            |
+--------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------+
...
```
