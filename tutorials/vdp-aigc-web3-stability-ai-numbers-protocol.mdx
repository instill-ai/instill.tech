---
title: "From Generative AI to Blockchain: Building a AIGC x Web3 Pipeline with Instill VDP"
lang: "en-US"
draft: false
...
```shellscript
{
    "outputs": [
        {
            "data_mapping_index": "01H6STT4J07GAVAC5824VYDPDP",
            "texts": [],
            "images": [
                {
            ...
            "metadata": {
                "asset_cids": [
                    "bafybeic27pv6qgnhqkrpcijvddsv6767lyqv4zpdl5woqjxok6aaaxuxom"
                ],
                "asset_urls": [
                    "https://nftsearch.site/asset-profile?cid=bafybeic27pv6qgnhqkrpcijvddsv6767lyqv4zpdl5woqjxok6aaaxuxom"
                ],
                "pipeline": {
                    "id": "aigc-web3",
                    "owner": "users/41db6f86-97b3-4374-8678-67ae639400f8",
                    "trigger_id": "84168814-b4fe-48a8-998e-f6a4a452989b",
...
To view the Web3 asset created above, navigate to the [link](https://nftsearch.site/asset-profile?cid=bafybeih6yidwyxqj75tlcawyvtslszhqx2vivlg6h6b47u4yisgi7xwi5q) in `asset_urls`.

By clicking on the [Asset ID](https://nftsearch.site/asset-profile?cid=bafybeic27pv6qgnhqkrpcijvddsv6767lyqv4zpdl5woqjxok6aaaxuxom), you can see the the asset creator, license details and information about the prompt, model and pipeline for creating this image.
