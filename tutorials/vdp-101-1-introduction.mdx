...
lang: "en-US"
draft: false
description: "Versatile Data Pipeline (VDP) is to streamline the end-to-end unstructured data pipeline with Artificial Intelligence (AI)."
aiTask: "Null"
...
**Versatile Data Pipeline (VDP)** is a source-available data infrastructure tool to streamline the end-to-end unstructured data pipeline with Artificial Intelligence (AI).
...
<ZoomableImg
  ...
  alt="VDP is an unstructured data infrastructure tool to seamlessly integrate AI for unstructured data into the modern data stack."
/>
