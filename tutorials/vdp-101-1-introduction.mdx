...
Okay, now you know what VDP is. Let's start with our following tutorial → [VDP 101 [2/7] Launch VDP on your local machine](/tutorials/vdp-101-2-quickstart?utm_source=blog&utm_medium=link&utm_campaign=vdp-101-1-introduction)!
