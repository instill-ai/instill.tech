...
Launch the VDP following [[2/7] Launch VDP on your local machine](/tutorials/vdp-101-2-quickstart) and install required dependencies with
...
2. **Model Instance**: select `yolov7/v1.0-cpu`under **Select an existing online model instance**
...
<CtaButton
  ...
  link="https://www.instill.tech/get-access/?utm_source=tutorial&utm_medium=link&utm_campaign=vdp-101"
/>
