...
- **PATH PARAMS**
    - **organizationModelName**: Use **`organizations/instill-ai/models/llava-1-6-13b`** for the LLaVA-v1.6-13B model.
- **BODY PARAMS**
    - **taskInputs**: Select **`VISUAL_QUESTION_ANSWERING OBJECT`**.
        - **prompt**: Enter your question for the model.
        - **promptImages**: Provide image data. You can use either:
            - **promptImageUrl**: URL of the image to analyze.
            - **promptImageBase64**: Base64-encoded image data.
  ...
  "taskInputs": [
    {
      "visualQuestionAnswering": {
        ...
        "promptImages": [
          {
            "promptImageUrl": "https://yourimageurl.com/image.jpg"
          }
        ]
      }
    }
