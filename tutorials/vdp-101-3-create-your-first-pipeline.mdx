...
You may be aware of the REST examples code that tiggers the pipeline at the bottom of this page. No worry about this now. You will learn how to tigger this piprline in the next tutorial → [VDP 101 - How to Tigger a Pipeline](/tutorials/vdp-101-4-how-to-trigger-a-sync-pipeline).
