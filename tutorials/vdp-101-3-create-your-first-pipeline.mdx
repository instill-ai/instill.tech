...
To fulfill objective detection tasks, we import a model from our public GitHub repository [instill-ai/model-yolov7-dvc](https://github.com/instill-ai/model-yolov7-dvc).
