...
Before we start creating the first pipeline, please ensure you have VDP services running on your machine. If not, you can set up your own VDP services with the guidelines in the tutorial [VDP 101 [2/7] Install VDP on Your Local Machine](/tutorials/vdp-101-2-installation).

## 1. Start Your First Pipeline with VDP
...
You may notice the REST examples code that triggers the pipeline at the bottom of this page. No worry about this now. You will learn how to trigger this pipeline in the following tutorial → [VDP 101 [4/7] How to Tigger a SYNC Pipeline](/tutorials/vdp-101-4-how-to-trigger-a-sync-pipeline).
