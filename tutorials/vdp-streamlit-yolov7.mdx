...
:::info{type=info}
[VDP standardises outputs for AI tasks](https://www.instill.tech/docs/core-concepts/ai-task?utm_source=tutorial&utm_medium=link&utm_campaign=vdp-streamlit-yolov7). Therefore, a model is modularised in a pipeline, and model outputs are in standard format for use in data integration or ETL pipeline.
:::
