...
<InfoBlock type="info" title="info">
  ...
  tasks](https://www.instill.tech/docs/core-concepts/ai-task?utm_source=tutorial&utm_medium=link&utm_campaign=vdp-streamlit-yolov7).
...
<InfoBlock type="info" title="info">
  ...
  tools](https://www.instill.tech/docs/import-models/overview?utm_source=tutorial&utm_medium=link&utm_campaign=vdp-streamlit-yolov7)
...
<Gallery
  images={[
    ...
    },
    {
      ...
      src: "/tutorial-assets/vdp-streamlit-yolov7/deploy-yolov4-cpu.png",
    },
    {
...
<InfoBlock type="info" title="info">
  ...
  [API-first](https://www.instill.tech/docs/core-concepts/overview?utm_source=tutorial&utm_medium=link&utm_campaign=vdp-streamlit-yolov7)
