...
publishedOn: "2023-01-30T18:31:00"
...
:::info{type=info}
**Pipeline** is the the most important concept in VDP. Check the [documentation](/docs/core-concepts/pipeline) for more details.
:::
...
The combination of the selected source and destination determines the pipeline mode.
