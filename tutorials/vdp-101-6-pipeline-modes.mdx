---
title: "VDP 101 - 6. Pipeline Modes: SYNC, ASYNC and PULL"
lang: "en-US"
draft: false
...
<img
    ...
    alt="In PULL mode, users trigger pipelines without uploading data. Pipeline will extract data from sources according its schedule and loaded ML modle inference results to destinations."
/>
