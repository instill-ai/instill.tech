...
To create an `ASYNC` pipeline, the source can be either HTTP or gRPC, and the destination can be any [VDP destination connectors](/docs/core-concepts/data-connector#destination).
