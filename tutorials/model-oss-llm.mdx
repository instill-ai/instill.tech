...
[Instill VDP](http://localhost:3010/docs/v0.4.1-alpha/welcome#instill-vdp) supports an AI connector to [Instill Model](/docs/latest/vdp/connectors/instill-model) where the user can import and serve custom models.
