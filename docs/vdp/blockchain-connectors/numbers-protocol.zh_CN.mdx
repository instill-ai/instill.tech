...
```shellscript cURL
curl --location 'http://localhost:8080/vdp/v1alpha/connecotor-resources'
...
The expected input data fields is the same strucutre as `input` fields of [Component Configuration](#component-configuration).
