...
<CH.Code>
<<<<<<< Updated upstream:docs/vdp/ai-connectors/stability-ai.zh_CN.mdx
...
>>>>>>> Stashed changes:docs/vdp/v1.0.0/ai-connectors/stability-ai.zh_CN.mdx
```
</ CH.Code>
...
| images                        | array[image]  | This is only required for "TASK_IMAGE_TO_IMAGE" task to specify initial image                                     |
