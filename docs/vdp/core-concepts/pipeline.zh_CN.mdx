...
### Template
  ...
  - A **Template** is like a variable reference.
  ...
  - After rendering, the VDP will search the value in upstream_component and rendor it to the data input, and it will also be converted to string type. 
