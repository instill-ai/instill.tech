...
A **Connector** is a fundamental building block used to construct a pipeline in VDP.
The system offers various types of connectors, each catering to specific functionalities.

Connectors empower VDP pipelines to perform unstructured data ETL (Extract, Transform, Load).
