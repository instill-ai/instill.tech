...
- **VDP Connectors** (including [data source connectors](/docs/source-connectors/overview), [data destination connectors](/docs/destination-connectors/overview) and model connectors): open-source and available under the MIT License
...
And we think the best way to build these integrations is via open source, no matter it is a data connector that connects data to a warehouse, application, or database, or a model connector that connects models that self-hosted or provided by 3rd party service.
