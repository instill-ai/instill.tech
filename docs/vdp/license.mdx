...
<ZoomableImg
  src="/docs-assets/start-here/vdp-license.svg"
...
Please read the [FAQ](#faq) section below regarding the license details.
...
On the other hand, we're releasing Instill Cloud, a fully-managed public cloud service built upon VDP that offers additional features.
