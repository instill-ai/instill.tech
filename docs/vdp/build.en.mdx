...
3. Add necessary components by selecting `Component +` and then choosing from the list.
4. In the component, define the `Task` and `Model` your pipeline will utilize, set up components by entering required details. This will vary depending on the chosen components.
