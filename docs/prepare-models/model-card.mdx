...
:::info{type=tip}
Technically, you can assign different AI task to model instances of the same model.
However, this is strongly discouraged. Model instances of a model should be designed to solve the same task.
:::
