...
lang: "en-US"
draft: false
description: "Learn about how to prepare a pre-processing Python model for the open-source unstructured data ETL tool VDP https://github.com/instill-ai/vdp"
---
