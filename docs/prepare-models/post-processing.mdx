...
:::info{type=info}
Learn more about [Image Classification task](/docs/core-concepts/ai-task#image-classification)
:::
...
:::info{type=info}
Learn more about [Object Detection task](/docs/core-concepts/ai-task#object-detection)
:::
...
:::info{type=info}
Learn more about [Keypoint Detection task](/docs/core-concepts/ai-task#keypoint-detection)
:::
...
:::info{type=info}
Learn more about [Instance Segmentation task](/docs/core-concepts/ai-task#instance-segmentation)
:::
...
:::info{type=info}
Learn more about [Unspecified AI task](/docs/core-concepts/ai-task#what-if-my-task-is-not-standardised-by-by-vdp-yet)
:::
