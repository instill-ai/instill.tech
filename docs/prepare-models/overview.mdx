...
lang: "en-US"
draft: false
description: "Learn about how to prepare your models for the open-source visual data ETL tool VDP https://github.com/instill-ai/vdp"
---

**Model** is the pipeline component used to process ingested visual data. VDP uses [Triton Inference server](https://github.com/triton-inference-server/server) for model serving. It supports multiple deep learning frameworks including TensorFlow, PyTorch, TensorRT, ONNX and OpenVINO.
