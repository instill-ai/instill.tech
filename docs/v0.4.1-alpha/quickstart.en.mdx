...
In this guide, we'll walk you through building your first VDP pipeline, focusing on a basic Generative pipeline using the [Stability AI AI Connector](./vdp/connectors/stability-ai), which seamlessly integrates with Stability AI's services.
