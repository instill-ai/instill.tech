...
The connector configuration is used for setting up the input data of this component. The configuration is configured in pipeline recipe, please refer to [pipeline](../../core/pipeline) for more details.
