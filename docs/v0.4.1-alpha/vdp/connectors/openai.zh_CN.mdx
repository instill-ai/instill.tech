...
curl -X POST https://api.instill.tech/vdp/v1alpha/users/<user_id>/connector-resources \
...
curl -X POST http://localhost:8080/vdp/v1alpha/users/<user_id>/connector-resources \
--data '{
  "id": "my-openai",
  "connector_definition_name": "connector-definitions/ai-openai",
  "configuration": {
