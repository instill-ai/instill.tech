...
[^3]: [State definition](https://www.instill.tech/docs/model/prepare)
...
[^4]: Check out our [task protocol](https://www.instill.tech/docs/model/ai-task) to learn more, or read our [json schema](https://raw.githubusercontent.com/instill-ai/connector-ai/main/pkg/instill/config/seed/data.json) directly
