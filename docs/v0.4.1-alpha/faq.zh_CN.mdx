...
<ToggleBlock>
  <details> 
    ...
    We used to suffer enough in connecting datas from different sources, devising our own deep learning models, putting the models in production, running the day-to-day operation,
    and endlessly building the peripheral MLOps tools to keep the production data pipeline resilient and AI performance consistent.
    All these happened in-house and were non-scalable.

    There must be a better way, and [Instill Core](welcome#instill-core-foundation-for-ai-first-applications) is the answer.
...
<ToggleBlock>
  <details> 
    ...
    <div align="center">
      <ZoomableImg
        src="/docs-assets/cloud/why-logo.png"
        alt="logo"
        width="400px"
      />
    </div>
