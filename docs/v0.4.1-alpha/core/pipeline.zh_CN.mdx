...
2. **resource_name**:
   ...
   - Refers to the connector resource. For more information, please refer to [AI Connectors](/docs/latest/vdp/ai-connector), [Data Connectors](/docs/latest/vdp/data-connector), or [Blockchain Connectors](/docs/latest/vdp/app-connector).
