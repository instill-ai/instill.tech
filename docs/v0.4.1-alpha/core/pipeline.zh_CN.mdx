...
2. **resource_name**:
   ...
   - Refers to the connector resource. For more information, please refer to [AI Connectors](/docs/latest/vdp/ai-connectors/overview), [Data Connectors](/docs/latest/vdp/data-connectors/overview), or [Blockchain Connectors](/docs/latest/vdp/blockchain-connectors/overview).
