...
lang: "en-US"
draft: false
description: "Learn about how to set up a Numbers Protocol blockchain connector for the unstructured data pipeline tool Instill Core https://github.com/instill-ai/instill-core"
---
...
For the up-to-date configuration, refer to [here](https://github.com/instill-ai/connector/blob/main/pkg/numbers/config/definitions.json).
...
The connector configuration is used for setting up the input data and parameters of this component. The configuration is configured in pipeline recipe, please refer to [pipeline](../../core/concepts/pipeline) for more details.
...
The expected input data fields has similar strucutre as `input` fields of [connector configuration](#connector-configuration).
