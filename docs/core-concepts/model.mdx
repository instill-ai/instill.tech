...
curl -k -X POST https://localhost:8080/v1alpha/models/{model-id}/instances/{instance-id}/test -d '{
  "inputs": [
    {
...
curl -k -X POST https://localhost:8080/v1alpha/models/{model-id}/instances/{instance-id}/test-multipart \
--form 'file=@"dog.jpg"' \
--form 'file=@"horse.jpg"'
```
