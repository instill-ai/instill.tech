...
A **Model** component is an algorithm run on unstructured visual data to solve a certain [CV Task](cv-task).
...
For example, when we say that **Model** is the core component of data pipeline to convert the unstructured visual data to structured insights, what actually happens underneath is the model instances being used to construct a data pipeline.
...
![VDP model and model instance](/docs-assets/core-concepts/model-and-model-instance.svg)
