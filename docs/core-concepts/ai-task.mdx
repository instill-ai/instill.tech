...
- _Semantic segmentation_ - classify image pixels into predefined categories
- _Text To Image_ - generates images from input text
- The list is growing ... 🌱
...
Text to image is a Vision task to creates images from a text description.
...
# Write the decoded image into file
filename = 'output_text_to_image.jpg' 
