...
lang: "en-US"
draft: false
description: "Learn about how to import local models into the open-source unstructured data ETL tool VDP https://github.com/instill-ai/vdp"
---
...
```shellscript cURL
curl -k -X POST https://localhost:8080/v1alpha/models:multipart \
--form 'id="yolov4"' \
...
```shellscript cURL
curl -k -X POST https://localhost:8080/v1alpha/models/yolov4/instances/latest/deploy
```
...
curl -k -X POST https://localhost:8080/v1alpha/models/yolov4/instances/latest/test -d '{
  "inputs": [
    {
...
curl -k -X POST https://localhost:8080/v1alpha/models/yolov4/instances/latest/test-multipart \
--form 'file=@"dog.jpg"'
```
