...
```shellscript cURL
curl -X POST http://localhost:8080/v1alpha/models/yolov4/instances/latest/deploy
```
...
curl -X POST http://localhost:8080/v1alpha/models/yolov4/instances/latest/test -d '{
  "inputs": [
    {
...
curl -X POST http://localhost:8080/v1alpha/models/yolov4/instances/latest/test-multipart \
--form 'file=@"dog.jpg"'
```
