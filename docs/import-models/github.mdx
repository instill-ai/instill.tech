...
```shellscript cURL
curl -k -X POST https://localhost:8080/v1alpha/models/yolov4/instances/v1.0-cpu/deploy
```
...
curl -k -X POST https://localhost:8080/v1alpha/models/yolov4/instances/v1.0-cpu/test -d '{
  "inputs": [
    {
...
curl -k -X POST https://localhost:8080/v1alpha/models/yolov4/instances/v1.0-cpu/test-multipart \
--form 'file=@"dog.jpg"'
```
