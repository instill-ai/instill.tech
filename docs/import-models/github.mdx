...
When importing a model from a GitHub repository, VDP creates one model according to the specified tag.
...
5. Fill the GitHub repository URL and the Git tag that stores the model files and click **Deploy**
6. Now go to the **Model** page, the corresponding model should be online
...
Current implementation does not support real-time GitHub sync: after you import a model from a specific tag of a GitHub repository, new releases of this GitHub tag won't be synced in VDP.
