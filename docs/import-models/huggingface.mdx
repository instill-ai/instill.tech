...
```shellscript cURL
curl -k -X POST https://localhost:8080/v1alpha/models/vit-base-patch16-224/instances/latest/deploy
```
...
curl -k -X POST https://localhost:8080/v1alpha/models/vit-base-patch16-224/instances/latest/test -d '{
  "inputs": [
    {
...
curl -k -X POST https://localhost:8080/v1alpha/models/vit-base-patch16-224/instances/latest/test-multipart \
--form 'file=@"dog.jpg"'
```
