...
VDP is not a general model serving framework!

VDP requires a model serving component specifically for computer vision models.
...
Last but not least, we love open sources.
