...
lang: "en-US"
draft: false
description: "Getting started with the open-source visual data ETL tool VDP https://github.com/instill-ai/vdp"
---
...
:::info{type=tip}
You can follow the tutorial [via](https://ffff.io) the **Pipeline** page. Or, you can navigate to the **Source**, **Model** and **Destination** page to create each component first and use them to configure a pipeline in **Pipeline** page later.
