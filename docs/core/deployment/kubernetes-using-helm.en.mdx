...
Access to the observability stack Jaeger ([http://localhost:16686](http://localhost:16686)),
and the Prometheus stack Prometheus ([http://localhost:9090](http://localhost:9090)) and Grafana ([http://localhost:3002](http://localhost:3002)) by port forwarding:
