...
Components empower pipelines to perform unstructured data ETL (Extract, Transform, Load). We have three types of component: **Connector**, **Operator** and **Iterator**
...
To enable VDP to process batch data, we introduce the **Iterator**.
The Iterator allows users to process items in a data array and then merge the results back into an array. It is similar to the well-known `map` function.
