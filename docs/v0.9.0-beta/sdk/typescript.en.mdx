...
| Function                                    | Params                                    |
| :------------------------------------------ | :---------------------------------------- |
| `listConnectorsQuery`                       | userName, pageSize, nextPageToken, filter |
| `listUserConnectorsQuery`                   | pageSize, nextPageToken, filter           |
| `listConnectorDefinitionsQuery`             | connectorDefinitionName                   |
| `getConnectorDefinitionQuery`               | connectorDefinitionName                   |
| `getUserConnectorQuery`                     | connectorDefinitionName                   |
| `watchUserConnector`                        | userName, payload                         |
| `createUserConnectorMutation`               | connectorDefinitionName                   |
| `deleteUserConnectorMutation`               | payload                                   |
| `updateUserConnectorMutation`               | payload                                   |
| `renameUserConnector`                       | payload                                   |
| `testUserConnectorConnectionAction`         | connectorDefinitionName                   |
| `connectUserConnectorAction`                | connectorDefinitionName                   |
| `disconnectUserConnectorAction`             | connectorDefinitionName                   |
