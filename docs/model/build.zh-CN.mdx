...
As the model image is pushed, **Instill Model** will automatically provision necessary resource for your model and deploy it.
Depends on your model image size and the type of hardware you specified for the model, it could take awhile for the model to be active.
