...
- Create a [model config](#model-configuration) `instill.yaml` file to describe your
...
- `instill.yaml` - [model config](#model-configuration) file that describe the model
  dependencies
