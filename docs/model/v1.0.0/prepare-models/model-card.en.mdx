...
lang: "en-US"
draft: false
description: "Learn about how to add a model card for the MLOps tool Instill Model https://github.com/instill-ai/model"
---
...
Please check the [supported standarised AI tasks in VDP](/docs/model/core-concepts/ai-task) and the corresponding output format for each task.
...
and the raw model output will be wrapped in a [standard format](/docs/model/core-concepts/ai-task#what-if-my-task-is-not-standardised-by-vdp-yet).
