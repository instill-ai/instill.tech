...
API_GATEWAY_BASE_VERSION=<api-gateway-base-version>
...
```shellscript .env
CONSOLE_PUBLIC_API_GATEWAY_BASE_HOST=<hostname-to-access-vdp>
...
- [`connector-backend`](https://github.com/instill-ai/connector-backend/blob/main/config/config.yaml)(`localhost:8082`):
- [`controller-vdp`](https://github.com/instill-ai/controller-vdp/blob/main/config/config.yaml):
