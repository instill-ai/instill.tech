...
If you'd like to **ask for a new model definition**, you can create an [issue](https://github.com/instill-ai/community/issues) or request it in the **#instill-model** channel on [Discord](https://discord.gg/sevxWsqpGh).
