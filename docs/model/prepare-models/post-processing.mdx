...
<InfoBlock type="info" title="info">
  ...
  task](/docs/vdp/core-concepts/ai-task#what-if-my-task-is-not-standardised-by-vdp-yet)
</InfoBlock>
...
Check the [standardised output for Unspecified AI task](/docs/vdp/core-concepts/ai-task#what-if-my-task-is-not-standardised-by-vdp-yet).
