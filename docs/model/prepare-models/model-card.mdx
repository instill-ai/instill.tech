...
Please check the [supported standarised AI tasks in VDP](/docs/vdp/core-concepts/ai-task) and the corresponding output format for each task.
...
and the raw model output will be wrapped in a [standard format](/docs/vdp/core-concepts/ai-task#what-if-my-task-is-not-standardised-by-vdp-yet).
