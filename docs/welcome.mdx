...
**Versatile Data Pipeline (VDP)** is an open-source unstructured data infrastructure tool to streamline the end-to-end unstructured data processing pipeline:
...
Check out the [quick start](/docs/vdp/getting-started) and understand the [core concepts](/docs/core-concepts/overview).
Then, learn about how to [deploy VDP](/docs/deployment/overview) in your infrastructure.
