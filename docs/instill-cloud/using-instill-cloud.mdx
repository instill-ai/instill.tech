...
**Step 1: Add a Trigger Operator**

The Trigger Operator serves as the starting point of a VDP pipeline.

To set up a Trigger operator,

1. Click the **Operator** on the left and drag **Trigger** into the canvas
2. Click **Create**
...
For this example, click the **AI** and drag a Stability AI AI connector with ID **instill-stable-diffusion-xl-1024-v0-9** into the canvas.

**Step 3: Set up a Response Operator**

The Response Operator is used at the end of a VDP pipeline to receive the output as a response when triggering the pipeline.

To set up a Response operator,

1. Click the **Operator** on the left and drag **Response** into the canvas
2. Click **Create**
...
1. Link the "texts" and "metadata" outputs of **trigger** component with the corresponding inputs of **instill-stable-diffusion-xl-1024-v0-9** component
2. Link the "images" and "metadata" output of **instill-stable-diffusion-xl-1024-v0-9** component to the corresponding input of **response** component
3. Link the "texts" output of **trigger** component to the corresponding input of **response** component
...
<ZoomableImg
  ...
  alt="Your first pipeline using Stability AI AI connector (Stable Diffusion XL 0.9)"
/>
...
<ZoomableImg
  ...
  alt="Generated sample using Stability AI AI connector (Stable Diffusion XL 0.9)"
/>
