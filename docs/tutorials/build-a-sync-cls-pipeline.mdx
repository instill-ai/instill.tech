...
<InfoBlock type="tip" title="tip">
  You can follow the tutorial via the **Pipeline** page. Or, you can navigate to
  the **Source**, **Model** and **Destination** page to create each component
  first and use them to configure a pipeline in **Pipeline** page later.
</InfoBlock>
