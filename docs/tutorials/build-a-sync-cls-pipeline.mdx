...
curl -k -X POST https://localhost:8080/v1alpha/source-connectors -d '{
    "id": "source-http",
...
curl -k -X POST https://localhost:8080/v1alpha/models -d '{
  "id": "mobilenetv2",
...
curl -k -X POST https://localhost:8080/v1alpha/models/mobilenetv2/instances/v1.0-cpu/deploy

curl -k -X POST https://localhost:8080/v1alpha/destination-connectors -d '{
  "id": "destination-http",
...
curl -k -X POST https://localhost:8080/v1alpha/pipelines -d '{
  "id": "classification",
...
curl -k -X POST https://localhost:8080/v1alpha/pipelines/classification/trigger -d '{
  "inputs": [
    {
...
curl -k -X POST https://localhost:8080/v1alpha/pipelines/classification/trigger-multipart \
--form 'file=@"dog.jpg"' \
...
in which `https://localhost:8080` is the `api-gateway` default URL.
