...
curl -k -X POST https://localhost:8080/v1alpha/models/yolov7/instances/v1.0-cpu/deploy
...
curl -k -X POST https://localhost:8080/v1alpha/pipelines/detection/trigger -d '{
  "inputs": [
    {
...
curl -k -X POST https://localhost:8080/v1alpha/pipelines/detection/trigger-multipart \
--form 'file=@"dog.jpg"' \
--form 'file=@"bear.jpg"'
```
