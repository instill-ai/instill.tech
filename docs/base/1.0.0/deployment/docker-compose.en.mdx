...
lang: "en-US"
draft: false
description: "Learn about how to deploy Instill Base https://github.com/instill-ai/base using Docker Compose"
---

Docker Compose is the most straightforward way to set up Instill Base in local machines or remote instances.
...
Once all services are up and running, the `api-gateway-base` can be accessed at [http://localhost:7080](http://localhost:7080)
and the `console` at [http://localhost:3000](http://localhost:3000).

## Shutdown

To shutdown and clean up all Base resources, run
...
or come to our [Discord](https://discord.gg/sevxWsqpGh) **#instill-base** channel. The community loves to help!
